...
The next decision identifier is **Q494**. Protocol-v3 Prompt design is decision-complete through Q493; implementation, real-provider verification, image work, and 2.5D remain separate later phases.
